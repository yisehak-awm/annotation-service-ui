        ...
        return (
            <React.Fragment>
                        ...
                        <Form.Item label="Gene name" style={{ marginBottom: '0' }}>
                            {getFieldDecorator("gene", {
                                ...
                                <Input
                                    ...
                                    onChange={e => this.setState({ currentGeneName: e.target.value.trim() })}
                                    onPressEnter={() => {
                    ...
                    <React.Fragment>
                        ...
                        {this.props.geneList && this.props.genes.length ? (
                            <Alert className="fileDetails"
                                ...
                                message={this.props.geneList.name + ' ( ' + this.props.geneList.size / 1000000 + ' MB )'}
                                type="info"
                            />
                        ) : null}
                    </React.Fragment>
                ...
                <div style={{ marginTop: '10px' }}>
                    ...
                    {
                        this.props.genes.length ? this.props.genes.map(gene =>
                            <Tag style={{ marginBottom: '5px' }} onClose={() => this.props.onGeneRemoved(gene)} key={gene} closable color="blue"> {gene} </Tag>
                        ) : null
                    }
                </div>
            </React.Fragment >
